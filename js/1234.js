...
const boylove3TakeTheFirstCount = 'lkboylove3TakeTheFirstCount'
const boylove3RunType = 'lkboylove3RunType'
const boylove3Sec = 'lkboylove3Sec'
const boylove3Msec = 'lkboylove3Msec'
const timeIntervalKey = 'lkboylove3TimeInterval'
const boylove3Cookie = lk.getVal(boylove3CookieKey, '')
const isTakeTheFirst = JSON.parse(lk.getVal(boylove3IsTakeTheFirst, false))
const takeTheFirstCount = lk.getVal(boylove3TakeTheFirstCount, 20)
const runType = lk.getVal(boylove3RunType, "1")
const sec = lk.getVal(boylove3Sec, 59)
const msec = lk.getVal(boylove3Msec, 0)
            ...
            "settings": [
                {
                    ...
                    "id": boylove3IsTakeTheFirst,
                    "name": "是否抢签到第一",
                    "val": false,
                    "type": "boolean",
                    "desc": "默认关闭"
                }, {
                    "id": boylove3TakeTheFirstCount,
                    "name": "抢签到第一并发数",
                    "val": 20,
                    "type": "number",
                    "desc": "默认20"
